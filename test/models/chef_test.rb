...
class ChefTest < ActiveSupport::TestCase
  ...
  def setup
    @chef = Chef.new(chefname: "Deanna", email: "deanna@example.com",
  ...
  test "email should accept correct format" do
    valid_emails = %w[user@example.com USER@example.com user.first@example.com user_first@example.com user+first@example.com ]
